...
export function Alert({ 
  ...
  return (
    <div className={`rounded-lg border p-4 ${variantClasses.container} ${className}`}>
      <div className="flex">
        <div className="flex-shrink-0">
          <div className={variantClasses.icon}>
            {displayIcon}
          </div>
        </div>
        <div className="ml-3 flex-1">
          ...
          <div className={`text-sm ${variantClasses.content} ${title ? 'mt-1' : ''}`}>
            {children}
          </div>
        </div>
        {dismissible && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                onClick={onDismiss}
                className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${variantClasses.container}`}
              >
